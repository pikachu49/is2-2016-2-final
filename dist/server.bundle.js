...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var ExpressServer_ts_1 = __webpack_require__(1);
	var index_ts_1 = __webpack_require__(85);
	var path = __webpack_require__(35);
	// Define Server
	var server = new ExpressServer_ts_1.ExpressServer();
	// Setup Server
	server.setupStatics('/statics', path.join(__dirname, 'statics'));
	// Start Server
	server.listen(index_ts_1.default.server.port).then(function () {
	    console.log('Server up at port ' + index_ts_1.default.server.port);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExpressServer = (function () {
	    ...
	    ExpressServer.prototype.use = function (middle) {
	        this.server.use(middle);
	    };
	    ExpressServer.prototype.setupStatics = function (route, staticsPath) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Setup
	var config = {};
	config.server = __webpack_require__(86);
